...
// using another pointer to point to allocated_list 
	struct block * allocate = allocated_list; 
//utilizing that pointer here to iterate
	while (allocate != NULL){
		print_list(allocate); 
...
void print_free() {
// using another pointer to point to freelist 
